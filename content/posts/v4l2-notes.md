...
![v2-7b72825dbb76f120f821a9ab0c7905da_r](/moonai.github.io/images/v4l2/v2-7b72825dbb76f120f821a9ab0c7905da_r-20260710185034-lap20xj.jpg)

先看正常的硬件拓扑结构，才能深入理解

![image](/moonai.github.io/images/v4l2/image-20260710184609-4pjbkn8.png)
...
![v2-69ea1f9d8bde110a0d34dcf13d5c68d3_r](/moonai.github.io/images/v4l2/v2-69ea1f9d8bde110a0d34dcf13d5c68d3_r-20260710185916-2p3who7.jpg)
...
![image](/moonai.github.io/images/v4l2/image-20260711151919-b7lggbh.png)

跳转到__video_register_device

![image](/moonai.github.io/images/v4l2/image-20260711152017-4bkiccr.png)
...
![image](/moonai.github.io/images/v4l2/image-20260711153057-ngd0sen.png)

注册/sys下的class

![image](/moonai.github.io/images/v4l2/image-20260711153200-gyqhsob.png)
...
![image](/moonai.github.io/images/v4l2/image-20260711155626-5e7ocvi.png)
...
![image](/moonai.github.io/images/v4l2/image-20260711162706-gjexrj3.png)

![image](/moonai.github.io/images/v4l2/image-20260711162748-ftrq6zv.png)
...
![image](/moonai.github.io/images/v4l2/image-20260711164326-1zhhryg.png)
...
![image](/moonai.github.io/images/v4l2/image-20260711194549-aqocpny.png)

在函数内部，先检测注册的fops是否提供了`unlocked_ioctl` 函数

![image](/moonai.github.io/images/v4l2/image-20260711194723-s8cp4vu.png)
...
![image](/moonai.github.io/images/v4l2/image-20260711200718-d3jai8a.png)

调用这个函数

![image](/moonai.github.io/images/v4l2/image-20260711201031-i3cd7i0.png)

![image](/moonai.github.io/images/v4l2/image-20260711201158-ohx7i4t.png)
...
![image](/moonai.github.io/images/v4l2/image-20260711202432-yd1f24k.png)

根据次设备号拿到注册的ioctl_ops

![image](/moonai.github.io/images/v4l2/image-20260711202738-j7zznm9.png)

查命令表

![image](/moonai.github.io/images/v4l2/image-20260711202901-6l6r8o6.png)
...
![image](/moonai.github.io/images/v4l2/image-20260711205310-hrf77vc.png)

![image](/moonai.github.io/images/v4l2/image-20260711221332-4abpyjc.png)
...
![image](/moonai.github.io/images/v4l2/image-20260712171502-zir9hed.png)
...
![image](/moonai.github.io/images/v4l2/image-20260712184608-8vjfr2m.png)
...
![image](/moonai.github.io/images/v4l2/image-20260712172746-kiblg9e.png)
...
![image](/moonai.github.io/images/v4l2/image-20260712200458-4m8mx9t.png)
...
![image](/moonai.github.io/images/v4l2/image-20260712200649-xhmukte.png)

`const struct vb2_mem_ops *mem_ops`：分配内存用的回调函数，通过下面几个宏来调用

![image](/moonai.github.io/images/v4l2/image-20260712200718-glpdkzf.png)

`const struct vb2_ops *ops`：硬件相关的回调函数，通过下面几个宏来调用

![image](/moonai.github.io/images/v4l2/image-20260712200728-cap7kr2.png)

这3个ops的层次图如下：

![image](/moonai.github.io/images/v4l2/image-20260712201055-pkoxolj.png)
