...
⑥复位硬件，关中断
devtype_data-&gt;resetdevtype_data-&gt;intctrl(0)
...
设备-驱动匹配与生命周期
SPI 核心
spi_master / spi_device / spi_message / spi_transfer
transfer_one_message / spi_sync
总线管理、消息泵、传输抽象
HOST 控制器
spi_imx_data / spi_imx_devtype_data / spi_bitbang
config / trigger / intctrl
硬件寄存器操作、PIO/DMA、中断
设备驱动
spidev_data / spi_ioc_transfer
read / write / ioctl
用户态接口、bounce buffer
用户接口
spi_ioc_transfer (定义在 spidev.h)
open / close / ioctl
用户态 SPI 控制